...
////// Emissive:
                ...
                float3 emissive = (_Alpha*lerp(_BottomColor.rgb,_TopColor.rgb,cos(((recipObjScale.b*(i.posWorld.b-objPos.b))+(node_3124.g*_Power)))));
